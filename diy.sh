...
git clone https://github.com/pikachullk/smartdns package/net/smartdns
git clone https://github.com/pikachullk/luci-app-smartdns package/lean/luci-app-smartdns
